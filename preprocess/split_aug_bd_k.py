...
from models import split_BD_Views_k, augmentation_BD_k, sound_test_finalizado
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="./preprocess/config_origin_format_seg.yaml", 
